...
mongoose.connect('mongodb+srv://RFv3aO5lhHY1Gf0b:GGbxMeIk0xqqaq7z@cluster0.lyg7a.mongodb.net/myFirstDatabase?retryWrites=true')
...
// 	.then(books => {
// 		console.log(`Success - added ${books.length} to the db`)
...
books.forEach(book => {
	Author.create(book.author)
		.then(createdAuthor => {
			// we replace the object with the id of the author
